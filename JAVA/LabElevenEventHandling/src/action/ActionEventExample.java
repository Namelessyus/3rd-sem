...
public class ActionEventExample extends JFrame implements ActionListener{
    ...
    public ActionEventExample(){
        ...
        // adding action Listerer to button
   ...
   public void actionPerformed (ActionEvent e){
       if (e.getSource() == btn_result){
               ...
               System.out.println ("Sum of two numbers: " + (num_one + num_two));
               JOptionPane.showMessageDialog(rootPane, "Sum of two numbers: " + (num_one + num_two));


               } catch(NumberFormatException error){
                   //will show message dialog
                   JOptionPane.showMessageDialog(rootPane, "Please enter numberic value");
               }
