...
public class Main {
    ...
    public static void main(String args[]) {
        /**
         * Constructor Overloading example creating object with constructor
         * having parameter and parameterless 1. default constructor i.e
         * parameterless constructor
         */
        ConstructorOverloadingExample eg_one = new ConstructorOverloadingExample();
        /**
         * we already have initialized the data to class variable inside default
         * constructor so whenever we create object using default constructor,
         * the data are passed automatically but if any of the attributes are
         * not assigned the value inside constructor then they will hold 'null;
         * value during the time of object creation
         */
        ...
        /**
         * 2. creating object with single parameter in case of our example we
         * have assigned value to 'username' only so except 'username' other
         * attributes will have 'null' value during creating object using this
         * constructor
         */
        ...
        System.out.println(
                "Area of Square: " + output);

        //4. method with type int and two parameter
        System.out.println(
                "Area of triangle: " + eg_four.area(5, 8));
