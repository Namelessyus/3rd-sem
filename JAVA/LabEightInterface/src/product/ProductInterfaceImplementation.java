...
public class ProductInterfaceImplementation implements ProductInterface{
    ...
    public String proudct_title;
    public double product_price;
    public String proudct_catagory;
    ...
    this.proudct_title = title;
    this.proudct_catagory = category;
    ...
    public void calculateProductPrice(){
        // calculate price using method as well
        ...
        System.out.println("Vat in Percent: Rs."+ this.vat_percent + "%");
